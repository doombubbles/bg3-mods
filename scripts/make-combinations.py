...
input = [
    unpacked_data / "Shared/Public/Shared/RootTemplates/_merged.lsf.lsx",
    unpacked_data / "Shared/Public/SharedDev/RootTemplates/_merged.lsf.lsx",
    unpacked_data / "Gustav/Public/Gustav/RootTemplates/_merged.lsf.lsx",
    unpacked_data / "Gustav/Public/GustavDev/RootTemplates/_merged.lsf.lsx",
]
