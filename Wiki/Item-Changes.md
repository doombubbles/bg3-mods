...
**?[[Quickspell Gloves]]** - Effect now usable once per combat instead of Short Rest

**?[[Gemini Gloves]]** - Effect now usable once per combat instead of Short Rest
...
**?[[Cap of Curing]]** - Now works with ?[[The Whispering Promise]], the ?[[Ring of Salving]], the ?[[Boots of Aid and Comfort]], ?[[Mantle of Inspiration]], and the ?[[Hellrider's Pride]] / ?[[The Reviving Hands]]
...
**?[[The Speedy Lightfeet]]** - No longer Medium armor, and now work for any movement speed buffing status being applied and not just Dash
...
**?[[Candle]]** - Having one in your inventory now unlocks a Candle Dip spell which functions like dipping your weapon in fire

**?[[Robe of the Weave]]** - Now has the more powerful ?[[Arcane Enchantment +2]], heals 1d6 per spell level, and also grants the ?[[Spell Resistance]] passive

**?[[Cloth of Authority]]** - Now lets you use ?[[Invoke the Black Hand]] once per Short Rest, a weaker version of Gortash's ?[[Avatar of Tyranny]] state (Resistance instead of Immunity, 15 temporary hit points instead of 150, ability damage divided by 4)

**?[[Mutilated Carapace]]** - ?[[Formless Slaughter]] bonus is +1d4 instead of +1, and lets you use ?[[Unsettling Visage]] once per short rest

**?[[Shelter of Athkatla]]** - Now gives access to weaker versions of ?[[Elemental Siphon]] and ?[[Elemental Retort]] (Resistance instead of immunity, 1d12 instead of 3d8, temporary access to Kereska versions of spells)

**?[[Despair of Athkatla]]** - Now lets you summon a Myrmidon (that can be used alongside standard Conjure Elemental)

**?[[Handmaiden's Mace]]** - Strength increased to 20, and gives you access to a 1d8 version of ?[[Shadow Ambush]]
